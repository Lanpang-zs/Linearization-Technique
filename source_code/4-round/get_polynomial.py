...
expand_expr_1=expand(temp_X[rounds-1][0][0]+temp_X[rounds-1][0][2]+temp_X[rounds-1][0][4])
expand_expr_2=expand(temp_X[rounds-1][0][1])
expand_expr_3=expand(temp_X[rounds-1][0][0]+temp_X[rounds-1][0][2]+temp_X[rounds-1][0][3])

deal_expression(str(expand_expr_1),"T0")
deal_expression(str(expand_expr_2),"X_1^4")
deal_expression(str(expand_expr_3),"T1")
